...
5. Wait for CI + Gemini review (check every ~60s until checks complete): `while ! gh pr checks --repo cuioss/cui-test-keycloak-integration <pr-number> --watch; do sleep 60; done`
